...
// import ContactUs from './aroma-template-components/ContactUs'
...
function Pages() {
    ...
    return (
        <Switch>
            ...
            {/* <Route path="/contact-us" exact component={isLogged ? ContactUs : NotFound} /> */}
            <Route path='/template' exact component={isLogged ? Main : NotFound} />
